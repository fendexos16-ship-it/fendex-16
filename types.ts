...
// Fix: Added payoutBatchId and razorpayPayoutId to LmdcLedgerEntry
...
// Fix: Added payoutBatchId and razorpayPayoutId to RiderLedgerEntry
...
// Fix: Added notes property to SlaAdjustment
...
export interface Client {
  ...
  // Fix: Fields should be optional to support older data and draft initialization
...
// Fix: Added approved/locked properties to AtlasServiceArea
